...
GEN_Warning_1                   :  'Your Keystore file is your private key encrypted by your wallet password.',
...
X_HelpfulLinks_4                :  'Migrating to/from VESwallet',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to VESwallet',
...
ONBOARD_welcome_content__4      :  'What is VESwallet? ',
ONBOARD_welcome_content__5      :  'VESwallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'VESwallet is not a Bank',
...
ONBOARD_interface_title         :  'VESwallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on VESwallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_bank_title__alt         :  'VESwallet isn\'t a Bank',
ONBOARD_blockchain_title__alt   :  'What is a Blockchain?',
ONBOARD_blockchain_skip         :  'I already know what a blockchain is...',
ONBOARD_blockchain_title        :  'Wait, what is a Blockchain?',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from VESwallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on wallet.ves.world or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
ONBOARD_interface_title__alt    :  'VESwallet is an Interface',
...
ONBOARD_blockchain_title__alt   :  'What is a Blockchain?',
ONBOARD_point_title__alt        :  'What\'s the Point of VESwallet then?',
ONBOARD_whymew_title            :  'If VESwallet can\'t do those things, what\'s the point?',
...
ONBOARD_whymew_content__6       :  'You can always use a hardware wallet with your VESwallet. Or, you can create a [home brewed wallet](https://wallet.ves.world) version of the hardware wallet.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like VESwallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
ONBOARD_secure_1_content__2     :  'Install [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) or [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) or [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) or the [VESwallet Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) to block malicious websites.',
ONBOARD_secure_1_content__3     :  'Always check the URL: https://wallet.ves.world/`.',
...
ONBOARD_secure_3_title__alt     :  'Avoid Phishers',
...
ONBOARD_secure_3_content__2     :  'Use VES to back up your password. Then make multiple encrypted copies of your private key on separate physical devices and then do not just store in computer. Do NOT just store it on your computer.',
ONBOARD_secure_3_content__3     :  'Store the copies of your encrypted private key in different physical locations. A backup is not useful if it is destroyed by a fire or flood along with your laptop.',
...
ONBOARD_secure_3_content__5     :  'If you have more than 1-week\'s worth of pay worth of cryptocurrency, consider getting a hardware wallet.',
...
ONBOARD_secure_2_title__alt_2   :  'Avoid Scams',
ONBOARD_final_title__alt        :  'One more click & you\'re done! 🤘',
ONBOARD_final_title             :  'Alright, we\'re done lecturing you!',
...
ONBOARD_final_content__3        :  'How to Set up VESwallet+ MetaMask',
ONBOARD_final_content__4        :  'How to Run VESwallet Offline / Locally',
...
/* Old */
ADD_DigitalBitbox_0a            :  'Re-open VESwallet on a secure (SSL) connection',
ADD_DigitalBitbox_0b            :  'Re-open VESwallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
...
ADD_Ledger_0a                   :  'Please use VESwallet on a secure (SSL / HTTPS) connection to connect.',
ADD_Ledger_0b                   :  'Re-open VESwallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/)',
...
GEN_Help_12                     :  'Use it to unlock your wallet via VESwallet (or Mist, Geth, Parity and other wallet clients.)',
...
MYWAL_Content_3                 :  'If you want to use this wallet with your VESwallet CX in the future, you will need to manually re-add it using the private key/JSON and password.',
MYWAL_Edit                      :  'Edit',
...
NODE_Warning                    :  'Your node must be HTTPS in order to connect to it via wallet.ves.world. You can [download the VESwallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
...
sidebar_donation                :  'VESwallet is a free, open-source service dedicated to your privacy and security. The more donations we receive, the more time we spend creating new features, listening to your feedback, and giving you what you want. We are just two people trying to change the world. Help us?',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different ETH node (e.g. `ETH (Etherscan.io)` or `ETH (Infura.io)` or `ETH (VESwallet)`) and check again.',
...
HELP_0_Desc_1                   :  'VESwallet gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_12_Desc_1                  :  'Using an Geth/Mist JSON file from VESwallet v2+....',
...
HELP_12_Title                   :  '12) How do I import a wallet created with VESwallet into geth / Ethereum Wallet / Mist?',
...
HELP_14_Desc_1                  :  'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, wallet.ves.world can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
HELP_14_Title                   :  '14) Some sites randomize (seed) the private key generation via mouse movements. wallet.ves.world doesn\'t do this. Is the random number generation for VESwallet safe?',
...
HELP_2b_Title                   :  '2b) How do I safely / offline / cold storage with VESwallet?',
...
HELP_3_Desc_3                   :  'Navigate to the wallet.ves.world "View Wallet Info" page.',
...
HELP_4CX_Title                  :  '4) How do I send Ether using VESwallet CX?',
HELP_5_Desc_1                   :  'You can run wallet.ves.world on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7                   :  'wallet.ves.world is now running entirely on your computer.',
HELP_5_Desc_8                   :  'In case you are not familiar, you need to keep the entire folder in order to run the website, not just `index.html`. Don\'t touch or move anything around in the folder. If you are storing a backup of the VESwallet repo for the future, we recommend just storing the ZIP so you can be sure the folder contents stay intact.',
HELP_5_Desc_9                   :  'As we are constantly updating wallet.ves.world, we recommend you periodically update your saved version of the repo.',
HELP_5_Title                    :  '5) How do I run wallet.ves.world offline/locally?',
...
HELP_8_Desc_1                   :  'VESwallet is not a web wallet. You don\'t have a login and nothing ever gets saved to our servers. It is simply an interface that allows you interact with the blockchain.',
HELP_8_Desc_2                   :  'If wallet.ves.world goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of VESwallet because it\'s not in VESwallet. It\'s in whatever wallet your generated via our site.',
...
HELP_8CX_Desc_2                 :  'That said, it is **very important** that you back up all your information for any new wallets generated with VESwallet CX. That way if anything happens to VESwallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets.',
HELP_8CX_Desc_3                 :  'If for some reason VESwallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above.',
HELP_8CX_Title                  :  '8) What happens if VESwallet CX disappears?',
...
HELP_Remind_Desc_1              :  '**Ethereum, wallet.ves.world & VESwallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**.',
HELP_Remind_Desc_2              :  'wallet.ves.world & VESwallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_SecCX_Desc_6               :  'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use wallet.ves.world instead of this Chrome Extension.',
HELP_SecCX_Title                :  'Security - VESwallet CX',
